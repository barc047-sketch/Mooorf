# MOOORF C0 M2 Owner Preview — One Inspector, Advanced Appearance and Symbol Tab

**Status:** OWNER PREVIEW ONLY — not authorized for Codex
**Prerequisite:** corrected M1 fixed head reviewed and merged with C0.4F-A.
...
3. the approved optional selection orbit if it remains temporary, non-exported and reduced-motion safe.

## 2. Proven inputs

- corrected M1 production Inspector and canonical appearance owners,
...
- opacity,
- optional canonical Cell shadow controls,
