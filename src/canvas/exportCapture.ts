...
type CaptureProvider = (options: CaptureRequestOptions) => Promise<CaptureResult>;
...
export const requestCanvasCapture = (options: CaptureRequestOptions): Promise<CaptureResult> => {
  if (!activeProvider) {
