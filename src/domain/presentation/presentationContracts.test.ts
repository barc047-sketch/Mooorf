...
equal(defaults.schemaVersion, 5, "presentation defaults schema version");
...
equal(defaults.void.style, "solid", "Void Edge has no mandatory technical dash by default");
...
equal(migratedV1.schemaVersion, 5, "presentation schema v1 migrates to the current version");
