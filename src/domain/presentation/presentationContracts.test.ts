...
equal(defaults.schemaVersion, 1, "presentation defaults schema version");
...
equal(defaults.boundary.style, "solid", "Boundary only supports the solid baseline");
...
const invalidResolved = resolveCellAppearance({
  ...
  appearance: {
    ...
    boundary: { visible: true, width: 999, offset: -999 },
    core: { size: -4 },
  },
}, defaults, context);
