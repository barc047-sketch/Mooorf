...
equal(defaults.schemaVersion, 6, "presentation defaults schema version");
...
equal(migratedV1.schemaVersion, 6, "presentation schema v1 migrates to the current version");
